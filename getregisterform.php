...
<head>
  ...
  <body>
    ...
    <tr>
    <br>
    <th><h2> Registered Students</h2></th> 
    </tr>
    ...
    ?>
    <tbody>
    <tr><td scope="row"><?php echo $rows['id'];?></td>
    <td scope="row"><?php echo $rows['name'];?></td>
    <td scope="row"><?php echo $rows['fathername'];?></td>
     <td scope="row"><?php echo $rows['contact'];?></td>
     <td scope="row"><?php echo $rows['email'];?></td>
     <td scope="row"><?php echo $rows['fathercontact'];?></td>
     <td scope="row"><?php echo $rows['address'];?></td>
     <td scope="row"><?php echo $rows['dob'];?></td>
     <td scope="row"><?php echo $rows['class'];?></td>
     <td scope="row"><?php echo $rows['institute'];?></td>
     <td scope="row"><?php echo $rows['country'];?></td>
     <td scope="row"><?php echo $rows['city'];?></td>
     <td scope="row"><?php echo $rows['paymentstatus'];?></td>
